...
@Component({
    ...
    templateUrl: './password-focus.component.html',
    providers: [
        {
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => PasswordFocusComponent),
            multi: true,
        }    
    ]
})
export class PasswordFocusComponent implements ControlValueAccessor  {
