...
@Component({
    ...
    templateUrl: './textarea-focus.component.html',
    providers: [
        {
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => TextAreaFocusComponent),
            multi: true,
        }     
    ]
})
export class TextAreaFocusComponent implements ControlValueAccessor  {
